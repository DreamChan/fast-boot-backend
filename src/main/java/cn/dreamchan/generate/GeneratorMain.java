...
public class GeneratorMain {
    ...
    //生成文件所在项目路径
    private static String baseProjectPath = "/Users/dreamchan/IdeaProjects/fast-boot-backend/";
//    private static String baseProjectPath = "D:\\IdeaProjects\\fast-boot-backend\\";
    ...
    //基本包名
    private static String basePackage = "cn.dreamchan.modules";
    ...
    private static String url = "jdbc:mysql://127.0.0.1:3306/fast-boot?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
    ...
    //table前缀
    private static String prefix = "cms_";

    //模块名称
    private static String modulesName = "cms";
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        InjectionConfig injectionConfig = new InjectionConfig() {
            ...
            map.put("BaseEntity" , "cn.dreamchan.common.base.BaseEntity");
            map.put("BaseController" , "cn.dreamchan.common.base.BaseController");
            map.put("BasePageQueryParam" , "cn.dreamchan.common.base.BasePageQueryParam");
            map.put("BaseService" , "cn.dreamchan.common.base.BaseService");
