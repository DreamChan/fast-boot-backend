...
import cn.dreamchan.modules.system.service.DictTypeService;
...
import cn.dreamchan.modules.system.service.DictItemService;
...
public class DictItemController extends BaseController<DictItemPageQueryParam, DictItemEntity> {
    ...
    @PreAuthorize("hasPermission('/system/dictItem',  'system:dict:query')")
    ...
    @PreAuthorize("hasPermission('/system/dictItem',  'system:dict:add')")
    ...
    @PreAuthorize("hasPermission('/system/dictItem',  'system:dict:edit')")
    ...
    @ApiOperation("删除字典数据")
    @ApiImplicitParam(name = "dictItemId", required = true, dataType = "Long", paramType = "path")
    @PreAuthorize("hasPermission('/system/dictItem',  'system:dict:delete')")
     ...
     */
    @ApiOperation("导出字典数据")
    @PreAuthorize("hasPermission('/system/dictItem',  'system:dict:export')")
    @SneakyThrows
