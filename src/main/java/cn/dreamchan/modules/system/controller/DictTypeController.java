...
public class DictTypeController extends BaseController<DictTypePageQueryParam, DictTypeEntity> {
    ...
    @PreAuthorize("hasPermission('/system/dictType',  'system:dict:query')")
    ...
    @PreAuthorize("hasPermission('/system/dictType',  'system:dict:add')")
    ...
    @PreAuthorize("hasPermission('/system/dictType',  'system:dict:edit')")
    ...
    @ApiOperation("删除字典类型")
    @ApiImplicitParam(name = "dictTypeId", required = true, dataType = "Long", paramType = "path")
    @PreAuthorize("hasPermission('/system/dictType',  'system:dict:delete')")
     ...
     */
    @ApiOperation("导出字典类型")
    @PreAuthorize("hasPermission('/system/dictType',  'system:dict:export')")
    @SneakyThrows
