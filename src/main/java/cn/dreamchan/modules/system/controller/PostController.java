...
public class PostController extends BaseController<PostPageQueryParam, PostEntity> {
    ...
    @PreAuthorize("hasPermission('/system/post',  'system:post:query')")
    ...
    @PreAuthorize("hasPermission('/system/post',  'system:post:add')")
    ...
    @PreAuthorize("hasPermission('/system/post',  'system:post:edit')")
    ...
    @ApiOperation("删除岗位信息")
    @ApiImplicitParam(name = "postId", required = true, dataType = "Long", paramType = "path")
    @PreAuthorize("hasPermission('/system/post',  'system:post:delete')")
     ...
     */
    @ApiOperation("导出岗位信息")
    @PreAuthorize("hasPermission('/system/post',  'system:post:export')")
    @SneakyThrows
