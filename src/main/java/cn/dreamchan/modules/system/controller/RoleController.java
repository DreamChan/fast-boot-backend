...
public class RoleController extends BaseController<RolePageQueryParam, RoleEntity> {
    ...
    @PreAuthorize("hasPermission('/system/role',  'system:role:query')")
    ...
    @PreAuthorize("hasPermission('/system/role',  'system:role:add')")
    ...
    @PreAuthorize("hasPermission('/system/role',  'system:role:edit')")
    ...
    @ApiOperation("删除角色信息")
    @ApiImplicitParam(name = "roleId", required = true, dataType = "Long", paramType = "path")
    @PreAuthorize("hasPermission('/system/role',  'system:role:delete')")
     ...
     */
    @ApiOperation("导出角色信息")
    @PreAuthorize("hasPermission('/system/role',  'system:role:export')")
    @SneakyThrows
