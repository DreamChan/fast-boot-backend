...
public class OperLogController extends BaseController<OperLogPageQueryParam, OperLogEntity> {
    ...
    @PreAuthorize("hasPermission('/monitor/operLog', 'monitor:operlog:query')")
    ...
    @PreAuthorize("hasPermission('/monitor/operLog',  'monitor:operlog:add')")
    ...
    @PreAuthorize("hasPermission('/monitor/operLog',  'monitor:operlog:edit')")
    ...
    @ApiImplicitParam(name = "operLogId", required = true, dataType = "Long", paramType = "path")
    @PreAuthorize("hasPermission('/monitor/operLog',  'monitor:operlog:delete')")
    ...
    @PreAuthorize("hasPermission('/monitor/operLog',  'monitor:operlog:export')")
    @SneakyThrows
